...
public class _01_Newsfeed {
    String[] trendingArticles;
    int[] views;
    double[] ratings;

    public _01_Newsfeed(String[] initialArticles, int[] initialViews, double[] initialRatings){
    ...
    public static void main(String[] args){
        ...
        _01_Newsfeed robotTimes = new _01_Newsfeed(robotArticles, robotViewers, robotRatings);
